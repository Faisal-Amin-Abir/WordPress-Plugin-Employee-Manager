...
type ControlTypes = 'default' | 'array' | 'checkbox' | 'color' | 'combobox' | 'date' | 'datetime' | 'email' | 'integer' | 'number' | 'password' | 'radio' | 'select' | 'telephone' | 'url' | 'text' | 'toggle' | 'toggleGroup';
