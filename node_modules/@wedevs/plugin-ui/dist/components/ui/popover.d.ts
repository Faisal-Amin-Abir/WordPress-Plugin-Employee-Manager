...
declare function PopoverPortal({ ...props }: PopoverPrimitive.Portal.Props): import("react/jsx-runtime").JSX.Element;
...
declare function PopoverArrow({ className, ...props }: PopoverPrimitive.Arrow.Props): import("react/jsx-runtime").JSX.Element;
export { Popover, PopoverContent, PopoverDescription, PopoverHeader, PopoverTitle, PopoverTrigger, PopoverPortal, PopoverClose, PopoverArrow, };
